        ...
        <Router>
          <Routes>
            ...
            <Route
              path="/shipping-transfers"
              element={
                isLoggedIn ? <ShippingTransfers /> : <LoginPage onLogin={handleLogin} />
              }
            />
            <Route
              path="/token-history"
              element={
                isLoggedIn ? <TokenHistory /> : <LoginPage onLogin={handleLogin} />
              }
            />
            <Route
              path="/accelerator-history"
              element={
                isLoggedIn ? <AcceleratorHistory /> : <LoginPage onLogin={handleLogin} />
              }
            />
            <Route
              path="/boosters-balance"
              element={
                isLoggedIn ? <BoostersBalance /> : <LoginPage onLogin={handleLogin} />
              }
            />
            <Route
              path="/token-balance"
              element={
                isLoggedIn ? <TokenBalance /> : <LoginPage onLogin={handleLogin} />
              }
            />
            <Route path="*" element={<Typography>الصفحة غير موجودة</Typography>} />
          </Routes>
        </Router>
      </QueryClientProvider>
    );
